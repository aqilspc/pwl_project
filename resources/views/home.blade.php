                        ...
                        <div class="page__heading d-flex align-items-end">
                            ...
                            <div class="flatpickr-wrapper ml-3">
                                <div id="recent_orders_date" data-toggle="flatpickr" data-flatpickr-wrap="true"
                                    ...
                                    <a href="{{url('admin/javascript:void(0)" class="link-date" data-toggle>13/03/2018 to
                                        20/03/2018</a>
                                                ...
                                                <div class="chart" style="height: 145px;">
                                                    <canvas id="locationDoughnutChart"
                                                        ...
                                                        <span style="font-size: 1rem;"
                                                            class="text-muted"><strong>Location</strong> doughnut chart
                                                            goes here.</span>
                                                    </canvas>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 py-2">
                                        <div
                                            ...
                                            <div class="flex">
                                                <h5 class="card-title mb-1"><a  class="headings-color">Mobile
                                                        UI</a></h5>
                                                <p class="text-muted mb-2">
                                                    <small class="mr-1"><a  class="text-muted">Steven
                                                            Doe</a></small>
                                    ...
                                    <div class="col-lg-6 py-2">
                                        <div
                                            ...
                                            <a ><img
                                                    ...
                                                    alt="Blog post image"></a>
                                            <div class="flex">
                                                <h5 class="card-title mb-1"><a  class="headings-color">DevOps
                                                        Basics</a></h5>
                                                <p class="text-muted mb-2">
                                                    <small class="mr-1"><a  class="text-muted">Kevin
                                                            Short</a></small>
                                    ...
                                    <div class="col-lg-6 py-2">
                                        <div
                                            ...
                                            <a ><img
                                                    ...
                                                    alt="Blog post image"></a>
                                            <div class="flex">
                                                <h5 class="card-title mb-1"><a  class="headings-color">New VueJS
                                                        Launch</a></h5>
                                                <p class="text-muted mb-2">
                                                    <small class="mr-1"><a  class="text-muted">Andrew
                                                            Robles</a></small>
                                    ...
                                    <div class="col-lg-6 py-2">
                                        <div
                                            ...
                                            <a ><img
                                                    ...
                                                    alt="Blog post image"></a>
                                            <div class="flex">
                                                <h5 class="card-title mb-1"><a  class="headings-color">E-Commerce
                                                        Analytics</a></h5>
                                                <p class="text-muted mb-2">
                                                    <small class="mr-1"><a  class="text-muted">Tara
                                                            Smith</a></small>
                        ...
                        <div class="card-deck card-margin">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="author-info">
                                            <a  class="text-body">Adrian Demian</a>
                                            <p class="text-muted mb-0">Senior Front-End Developer</p>
                                        </div>
                                    </div>
                                    <h5 class="card-title"><a  class="headings-color">UI Design &amp; Code</a>
                                    </h5>
                            ...
                            <div class="card dashboard-chat">
                                ...
                                <div class="d-flex dashboard-chat__head">
                                    ...
                                    <div class="flex">
                                        <a  class="text-body">Steven Short</a>

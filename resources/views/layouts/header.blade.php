...
<head>
    ...
    <!-- Perfect Scrollbar -->
    <link type="text/css" href="{{url('admin/assets/vendor/perfect-scrollbar.css')}}" rel="stylesheet">

    <!-- App CSS -->
    <link type="text/css" href="{{url('admin/assets/css/app.css')}}" rel="stylesheet">
    <!-- <link type="text/css" href="{{url('admin/assets/css/app.rtl.css')}}" rel="stylesheet"> -->

    <!-- Material Design Icons -->
    <link type="text/css" href="{{url('admin/assets/css/vendor-material-icons.css')}}" rel="stylesheet">
    <!-- <link type="text/css" href="{{url('admin/assets/css/vendor-material-icons.rtl.css')}}" rel="stylesheet"> -->

    <!-- Font Awesome FREE Icons -->
    <link type="text/css" href="{{url('admin/assets/css/vendor-fontawesome-free.css')}}" rel="stylesheet">
    <!-- <link type="text/css" href="{{url('admin/assets/css/vendor-fontawesome-free.rtl.css')}}" rel="stylesheet"> -->
...
<!--     <script>
    ...
    <!-- Flatpickr -->
    <link type="text/css" href="{{url('admin/assets/css/vendor-flatpickr.css')}}" rel="stylesheet">
    <!-- <link type="text/css" href="{{url('admin/assets/css/vendor-flatpickr.rtl.css')}}" rel="stylesheet"> -->
    <link type="text/css" href="{{url('admin/assets/css/vendor-flatpickr-airbnb.css')}}" rel="stylesheet">
    <!-- <link type="text/css" href="{{url('admin/assets/css/vendor-flatpickr-airbnb.rtl.css')}}" rel="stylesheet"> -->

    <!-- Vector Maps -->
    <link type="text/css" href="{{url('admin/assets/vendor/jqvmap/jqvmap.min.css')}}" rel="stylesheet">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div id="notifications_menu"
                                    ...
                                    <div class="dropdown-item d-flex align-items-center py-2">
                                        ...
                                        <a href="{{url('admin/javascript:void(0)" class="text-muted"><small>Clear all</small></a>
                                    </div>
                                    <div class="navbar-notifications-menu__content" data-perfect-scrollbar>
                                        <div class="py-2">
                                            ...
                                            <div class="dropdown-item d-flex">
                                                ...
                                                <div class="flex">
                                                    <a >A.Demian</a> left a comment on <a
                                                        >FlowDash</a><br>
                                    ...
                                    <a href="{{url('admin/javascript:void(0);"
                        ...
                        <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                            <li class="nav-item dropdown">
                                ...
                                <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item active" href="{{url('admin/index.html"><i class="material-icons">dvr</i>
                                        Dashboard</a>
                                    <a class="dropdown-item" href="{{url('admin/profile.html"><i
                                            class="material-icons">account_circle</i> My profile</a>
                                    <a class="dropdown-item" href="{{url('admin/edit-account.html"><i class="material-icons">edit</i>
                                        Edit account</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{url('admin/login.html"><i class="material-icons">exit_to_app</i>
                                        Logout</a>
                                </div>
                            </li>
                        </ul>
